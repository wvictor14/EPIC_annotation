...
data %>% 
  ...
  mutate(previous_stop = cummax(lag(stop, default = 0)),
         new_group = (start >= previous_stop),
...
Noticed there are some NAs in the genes_symbol column. I remove these in this update:
